...
public class RestAccessDeniedHandler implements AccessDeniedHandler {
	...
	public void handle(HttpServletRequest request, HttpServletResponse response,
		...
		response.getWriter()
			.println(GenericJacksonUtil.objectToJson(ResponseVO.error(Code.UN_AUTHENTICATION.getCode(),
					Code.UN_AUTHENTICATION.getZhDescription(), accessDeniedException.getMessage())));
